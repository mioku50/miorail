<!-- Excerpt of https://docs.base.org/base-chain/asset-issuance/tokenized-stocks-on-base.md,
     fetched 2026-08-25. The two tables the parser reads, and the prose between
     them, kept verbatim so a change in the document's shape breaks a test here
