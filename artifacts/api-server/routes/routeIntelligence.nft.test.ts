...
const FLAGS = {
  ...
  nftRouteV1: true,
  nftExecutionV1: true, privateAiRouteV1: false, privateAiExecutionV1: false, aerodromeExecutionV1: false, b20ControlV1: false, b20PublicContextV1: false, b20TargetedMeasureV1: false, submissionRecoveryV1: false, publicProofV1: false, mcpPrivateV1: false, mcpPrivateExecutionV1: false, routeOutcomeFeedbackV1: false, tokenIdentityV1: false,
};
...
describe('prepare loads the reviewed card, and refuses a moved listing', () => {
  ...
  test('the purchase gate being off makes nothing signable', async () => {
    nftRouteRuntime.flags = () => ({ ...FLAGS, nftExecutionV1: false, privateAiRouteV1: false, privateAiExecutionV1: false, aerodromeExecutionV1: false, b20ControlV1: false, b20PublicContextV1: false, b20TargetedMeasureV1: false, submissionRecoveryV1: false, publicProofV1: false, mcpPrivateV1: false, mcpPrivateExecutionV1: false, routeOutcomeFeedbackV1: false, tokenIdentityV1: false, });
    const { prepare } = await prepared();
    assert.equal(prepare.body.signable, false);
