...
describe('Status API', () => {
  ...
  test('GET /api/status exposes only safe migration booleans with compatibility defaults', async () => {
    ...
    assert.deepStrictEqual(response.body.productMigration, {
      ...
      privateAiExecutionV1: false, aerodromeExecutionV1: false, o1ExecutionV1: false, hydrexExecutionV1: false, balancerExecutionV1: false, b20ControlV1: false, submissionRecoveryV1: false, publicProofV1: false, routeOutcomeFeedbackV1: false,
