...
function resetRuntime() {
  ...
  budgetRouteRuntime.flags = () => ({ routeIntelligenceV1: true, legacyTerminal: true, paidIntelligence: true });
...
describe('T60 Intelligence Budget CRUD routes', () => {
  ...
  test('all budget routes 404 when paidIntelligence is off even with routeIntelligenceV1 on', async () => {
    budgetRouteRuntime.flags = () => ({ routeIntelligenceV1: true, legacyTerminal: true, paidIntelligence: false });
