...
const FLAGS = {
  ...
  aerodromeExecutionV1: false, b20ControlV1: false, submissionRecoveryV1: false, publicProofV1: false, mcpPrivateV1: false, mcpPrivateExecutionV1: false, routeOutcomeFeedbackV1: false,
};
...
describe('the gates', () => {
  ...
  test('comparing is allowed while executing is not', async () => {
    aiRouteRuntime.flags = () => ({ ...FLAGS, privateAiExecutionV1: false, aerodromeExecutionV1: false, b20ControlV1: false, submissionRecoveryV1: false, publicProofV1: false, mcpPrivateV1: false, mcpPrivateExecutionV1: false, routeOutcomeFeedbackV1: false, });
    const app = routeApp();
