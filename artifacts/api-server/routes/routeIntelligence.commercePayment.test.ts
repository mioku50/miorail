...
const FLAGS = {
  ...
  nftRouteV1: false,
  nftExecutionV1: false, privateAiRouteV1: false, privateAiExecutionV1: false, aerodromeExecutionV1: false, b20ControlV1: false, submissionRecoveryV1: false, publicProofV1: false,
} as const;
...
describe('T64.3 payment prepare', () => {
  ...
  test('the execution gate keeps the whole rail closed', async () => {
    const opened = await openCheckout();
    commerceRouteRuntime.flags = () => ({ ...FLAGS, commerceExecutionV1: false, nftRouteV1: false, nftExecutionV1: false, privateAiRouteV1: false, privateAiExecutionV1: false, aerodromeExecutionV1: false, b20ControlV1: false, submissionRecoveryV1: false, publicProofV1: false, });
