...
test('migration flags accept only explicit boolean values', () => {
  assert.deepStrictEqual(
    getMiorailProductMigrationFlags({
      ...
      MIORAIL_BALANCER_EXECUTION_V1: 'true',
    }),
    {
